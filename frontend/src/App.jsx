  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white shadow-xl rounded-2xl p-6 space-y-4">
        <h1 className="text-2xl font-bold text-gray-800">Try e.e.r.s (limited to Nevada)</h1>
      ...
      <footer className="w-full text-center text-sm text-gray-500 mt-4">
        Contact information: <a href="mailto:support@eers.us" className="underline">support@eers.us</a>
      </footer>
    </div>
  );
}