...
client = AzureOpenAI(  
    ...
    - When providing links, finish the response by asking suggestive questions to the user to try and narrow down what they're looking for from the list you're providing. Don't replace the question with the link.
    """
    # Your role is to:
