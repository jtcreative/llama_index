...
client = AzureOpenAI(  
    ...
    - When you provide links, you need to also provide a list of 5-6 resources available in that link or locations in Pennsylvania (with address) related to that link
    """
    # Your role is to:
